...
**日時**: 2026-03-XX（予定）
**前提**: Session 58でリポジトリ整理完了、ADR-004で方針決定済み

---

## 目的

GNSS評価ツールのプロトタイプ作成（Session 58からの引き継ぎ）
...
- [Session 58サマリー](../session58/session-summary.md)
- [ADR-004](../../docs/adr/ADR-004-gnss-tool-approach.md) — 方針決定
