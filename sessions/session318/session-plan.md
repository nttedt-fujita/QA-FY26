...
**前セッション**: [Session 317](../session317/session-summary.md)
...
| # | 作業 | 理由 |
|---|------|------|
| 1 | kintone CSV再取得（全期間、Windows PCで） | S317で2ヶ月分しかないことが判明 |
| 2 | AgriシートとkintoneCSVの突合 | PSI自動化の前提確認 |
| 3 | PSIプロトタイプのアプローチ整理 | S313構想 + 技術的制約を踏まえた設計方針 |
| 4 | 整理すべき項目の全体リスト（優先度・緊急度） | 何を次にやるかの判断材料 |
| 5 | S317の分析内容の正確性検証 | 資料を大量に作ったが正しいか確認 |
...
- kintone CSV再取得はWindows PCで実施
- フィルタなしで全レコードを出力すること
- kintone「受入製品」アプリのCSVも取得を検討

---

*作成: Session 317終了時 (2026-03-26)*
