...
| サブミッション | ステータス | 次アクション |
|---------------|-----------|-------------|
| **M1-A: Lidar** | 調査完了・計画策定待ち | 評価計画書の作成 |
| **M1-B: GNSS** | Phase 1データ読み込み完了 | **再開予定**: 合格基準検討 → 末永さんヒアリング |
...
| ファイル | 内容 |
|----------|------|
| [gnss/README.md](gnss/README.md) | GNSS評価ドキュメント一覧 |
| [gnss/07-cross-sheet-findings.md](gnss/07-cross-sheet-findings.md) | 合格基準叩き台・末永さんヒアリング項目 |
